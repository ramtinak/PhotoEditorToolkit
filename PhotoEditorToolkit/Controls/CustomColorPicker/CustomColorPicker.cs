// A copy from https://github.com/UnigramDev/Unigram/blob/develop/Unigram/Unigram/Controls/ColorPicker.cs
...
namespace PhotoEditorToolkit.Controls
{
    ...
    public class CustomColorPicker : Control
    {
        ...
        public event TypedEventHandler<CustomColorPicker, ColorChangedEventArgs> ColorChanged;
        ...
        public static readonly DependencyProperty ColorProperty =
            DependencyProperty.Register("Color", typeof(Color), typeof(CustomColorPicker), new PropertyMetadata(Colors.Red, OnColorChanged));

        private static void OnColorChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((CustomColorPicker)d).OnColorChanged((Color)e.NewValue, (Color)e.OldValue);
        }
